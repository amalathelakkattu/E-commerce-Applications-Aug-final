    ...
    >
      <Container fluid>
        ...
        >
          ...
          <Link
            to={"/"}
            className="nav-link text-decoration-none d-flex align-items-center gap-2"
          >
            {/* ✅ Add your PNG logo here */}
            <img
              src="/design-assets/electrohub-logo.png"
              alt="ElectroHub Logo"
              width="70"
              height="70"
            ...
            />
            {/* <div>
              <span className="text-white h1 fw-bold">Electo</span>
              <span className="text-secondary h1 fw-bolder">Hub</span>
            </div> */}
          </Link>
        </Navbar.Brand>
