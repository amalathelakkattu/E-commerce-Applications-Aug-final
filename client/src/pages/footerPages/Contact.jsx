      ...
      <div className="text-white d-flex justify-content-center align-items-center my-5 flex-column gap-2 flex-wrap">
        ...
        <div className={theme ? "text-center text-black" : "text-center"} style={{ maxWidth: 500 }}>
          <p>
            ...
            At <strong>ElectroHub</strong>, we’re here to help! Our team is ready 
            to support you with all inquiries related to Mobiles, Laptops, iPods, 
            Watches, and Accessories. <br /><br />
          ...
          <p className="mt-4">
            ...
            Email: <a href="mailto:electro.95hub@gmail.com">electro.95hub@gmail.com</a><br />
            Phone: +91 98765 43210<br />
            Address: 123 ElectroHub Avenue, Tech City, Kerala, India
          </p>

          <p>We look forward to assisting you and making your shopping experience seamless!</p>
        </div>
      </div>
    </Container>
  );
