    ...
    <Container fluid className="p-5">
      <div className="text-white d-flex justify-content-center align-items-center my-5 flex-column gap-2 flex-wrap">
        <div className="my-5">
          ...
          >
            Marketing at ElectroHub
          </h1>
        </div>
        <div className={theme ? "text-center text-black" : "text-center"}>
          <p>
            At <strong>ElectroHub</strong>, our marketing efforts focus on connecting 
            with tech enthusiasts who love Mobiles, Laptops, iPods, Watches, and Accessories. 
            We combine data-driven strategies, creativity, and customer engagement to 
            deliver the right message to the right audience at the right time. <br /><br />

            <strong>Our Marketing Approach:</strong> <br />
            We focus on understanding our customers’ preferences, creating compelling content, 
            and driving engagement across multiple channels. Here’s how we approach marketing:
            <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
              <li>
                <strong>Digital Advertising:</strong> Targeted campaigns on Google, Instagram, 
                and Facebook to drive traffic and conversions.
              </li>
              <li>
                <strong>Content Marketing:</strong> Blogs, product reviews, and guides to help 
                customers make informed decisions.
              </li>
              <li>
                <strong>Influencer Collaborations:</strong> Partnering with tech influencers 
                to showcase real-world use of our products.
              </li>
              <li>
                <strong>Email Campaigns:</strong> Personalized offers and product recommendations 
            ...
            Here are some of our active campaigns:
            <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
              <li>
                <Button
                  variant="link"
                  ...
                  target="_blank"
                >
                  iPhone 15 Launch Campaign
                </Button>
              </li>
              <li>
                <Button
                  variant="link"
                  href="/campaigns/laptop-deals"
                  target="_blank"
                >
              ...
              <li>
                <Button
                  variant="link"
                  href="/campaigns/accessory-collection"
                  target="_blank"
                >
            ...
            Marketing materials for partners and collaborators:
            <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
              <li>
                <Button
                  variant="link"
                  href="/marketing-assets/electrohub-banner.jpg"
                  target="_blank"
                >
                  ElectroHub Banner Ad (300x250)
                </Button>
              </li>
              <li>
                <Button
                  variant="link"
                  href="/marketing-assets/product-video.mp4"
                  target="_blank"
                >
                  Product Promo Video
                </Button>
            ...
            <br />
            For collaboration requests, partnership inquiries, or more information 
            about our marketing strategy, please contact our team at{" "}
            <a href="mailto:marketing@electrohub.com">marketing@electrohub.com</a>.
          </p>
        </div>
      </div>
    </Container>
