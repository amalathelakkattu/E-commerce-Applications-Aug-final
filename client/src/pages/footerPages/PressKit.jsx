    ...
    <Container fluid className="p-5">
      <div className="text-white d-flex justify-content-center align-items-center my-5 flex-column gap-2 flex-wrap">
        <div className="my-5">
          ...
          >
            ElectroHub Press Kit
          </h1>
        </div>
        <div className={theme ? "text-center text-black" : "text-center"}>
          <p>
            Welcome to the <strong>ElectroHub Press Kit</strong>! Here you'll find all the 
            resources you need to cover our brand, products, and services. 
            Whether you’re a journalist, blogger, or influencer, we’ve made it easy 
            to access the latest news, images, logos, and other media assets. <br /><br />
            ...
            <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
              <li>
                <Button
                  ...
                  target="_blank"
                >
                  ElectroHub Launches New Mobile Collection - Press Release
                </Button>
              </li>
              <li>
                <Button
                  ...
                  target="_blank"
                >
                  ElectroHub Expands Product Range - Press Release
                </Button>
              </li>
            </ul>
            ...
            Download high-resolution images of our products and logos for your articles:
            <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
              <li>
              ...
              <li>
                <Button variant="link" href="/mobile-image.jpg" target="_blank">
                  Mobile Collection Image
                </Button>
              </li>
              <li>
                <Button variant="link" href="/store-front.jpg" target="_blank">
                  ElectroHub Storefront Image
                </Button>
              </li>
            </ul>
            ...
            ElectroHub is a leading retailer of premium technology products, 
            offering Mobiles, Laptops, iPods, Watches, and Accessories. Our mission 
            is to provide authentic, high-quality products with exceptional customer 
            service and competitive pricing. <br /><br />
            
            For additional information or specific requests, please contact our PR 
            team at <a href="mailto:press@electrohub.com">press@electrohub.com</a>.
          </p>
        </div>
      </div>
    </Container>
